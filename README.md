...
The original author has deleted the library (now it's taken over by Yu Ban), and just copied and backed up to make his own warehouse for his own use! ! !
...
```
wget -N https://raw.githubusercontent.com/css1122/XrayR-release/main/install.sh && bash install.sh
```
